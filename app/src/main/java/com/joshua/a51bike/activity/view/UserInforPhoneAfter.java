 ...
 * @since 2017-03-12
 */
@ContentView(R.layout.user_infor_pafter)
public class UserInforPhoneAfter extends BaseActivity {
    private static final String TAG = "UserInforPhoneBefor";

    private String upPhone_url = AppUtil.BaseUrl +"/user/login";
    ...
    public void next(View view){
        ...
        RequestParams params = new RequestParams(upPhone_url);
        params.addBodyParameter("username",Ephone.getText().toString());
