...
public class DetailFragment extends Fragment {
    ...
    public static DetailFragment f;
    ...
    public static DetailFragment newInstance(String url,String from) {
...
//        gsonBuilder.setDateFormat("mm:ss");
        ...
        Type type = new TypeToken<ArrayList<Recharge>>() {}.getType();
        List<Recharge> d  =gson.fromJson(msg, type);
        data.addAll(d);
        adapter.RefreshDate(data);
        for(Recharge re: data){
            Log.i(TAG, "addDate: "+re.getId()
                    +"\n"+re.getUserCharge()+"\n"
                    +format.format(new Date(re.getUserTime().getTime())));
        }
        isEmptyDate();
    }
